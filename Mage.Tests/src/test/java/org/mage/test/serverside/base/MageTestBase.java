...
//        }
  ...
  protected Player createPlayer(String name, PlayerType playerType, int skill) {
    Optional<Player> playerOptional = PlayerFactory.instance.createPlayer(playerType, name, RangeOfInfluence.ALL, skill);
